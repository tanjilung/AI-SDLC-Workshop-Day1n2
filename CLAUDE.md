...
A **Next.js 16** todo application with WebAuthn authentication, using **PostgreSQL** (pg + drizzle-orm) for data persistence and **Playwright** for E2E testing. All operations use **Singapore timezone** (`Asia/Singapore`).
